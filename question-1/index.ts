...
function string_length_fun(string1){
    return string1.length;
    
}
console.log("LENGTH OF STRING SWITZERLAND IS:",string_length_fun("SWITZERLAND"));

console.log("LENGTH OF STRING PAKISTAN IS:",string_length_fun("PAKISTAN"));


console.log("LENGTH OF STRING AMERICA IS:",string_length_fun("AMERICA"));
